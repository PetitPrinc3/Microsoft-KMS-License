# Installer et activer la suite Office

```Référence : https://msguides.com/office-2021```

⚠️ Il est fortement conseillé de désinstaller complètement toute installation existante de la suite office.
...
Une fois le fichier téléchargé, procédez à l'installation des logiciels.
Vous pouvez ensuite fermer toutes les fenêtres ouvertes par des produits Office.
...
Une fois que le script à fini de s'exécuter Office est activé ! 
Vous pouvez redémarrer votre PC pour s'assurer que le crack à bien fonctionné.

Pour s'en assurer, rendez-vous dans les paramètres de compte de Word par exemple et vérifiez que le produit est bien activé.
